...
// Binary Search - cari berdasarkan rating (angka)
void binarySearchRating(DataAnimasi *dataAnimasi, int jumlahData){
    ...
    int ratingDicari;
    cout<<"Masukkan rating yang dicari (1-10) : ";
    cin>>ratingDicari;
    ...
    while(indeksKiri<=indeksKanan){
        ...
        if((salinanData+indeksTengah)->rating == ratingDicari){
            ...
            cout<<endl<<"=== Hasil Binary Search - Rating "<<ratingDicari<<" ==="<<endl;
            cout<<"====================================="<<endl;

            for(int i=posisiAwal; i<jumlahData && (salinanData+i)->rating==ratingDicari; i++){
                cout<<left;
                cout<<setw(10)<<"Judul"<<": "<<(salinanData+i)->judul<<endl;
                cout<<setw(10)<<"Studio"<<": "<<(salinanData+i)->studio<<endl;
                cout<<setw(10)<<"Tipe"<<": "<<(salinanData+i)->tipe<<endl;
                cout<<setw(10)<<"Rating"<<": "<<(salinanData+i)->rating<<"/10"<<endl;
                cout<<setw(10)<<"Ulasan"<<": "<<(salinanData+i)->ulasan<<endl;
                cout<<"-------------------------------------"<<endl;
            }
    ...
    if(ditemukan==false){
        cout<<"Data dengan rating "<<ratingDicari<<" tidak ditemukan"<<endl;
    }
}

// Jump Search - cari berdasarkan judul (kata)
void jumpSearchJudul(DataAnimasi *dataAnimasi, int jumlahData){
    ...
    for(int i=posisiSebelum; i<batasAkhir; i++){
        if((salinanData+i)->judul == judulDicari){
            cout<<endl<<"=== Hasil Jump Search - Judul \""<<judulDicari<<"\" ==="<<endl;
            cout<<"====================================="<<endl;
            cout<<left;
            cout<<setw(10)<<"Judul"<<": "<<(salinanData+i)->judul<<endl;
            cout<<setw(10)<<"Studio"<<": "<<(salinanData+i)->studio<<endl;
    ...
    if(ditemukan==false){
        cout<<"Judul \""<<judulDicari<<"\" tidak ditemukan"<<endl;
    }
}
...
void menuSearching(DataAnimasi dataAnimasi[], int jumlahData){
    ...
    cout<<"=== Menu Searching ==="<<endl<<endl;
    cout<<"1. Binary Search - Cari berdasarkan Rating (angka)"<<endl;
    cout<<"2. Jump Search   - Cari berdasarkan Judul  (kata)"<<endl;
    cout<<"3. Kembali"<<endl<<endl;
    cout<<"Pilih metode searching : ";

    int pilihanSearching;
    cin>>pilihanSearching;

    system("cls");

    if(pilihanSearching==1){
        binarySearchRating(dataAnimasi, jumlahData);
    }
    else if(pilihanSearching==2){
        jumpSearchJudul(dataAnimasi, jumlahData);
    }
    else if(pilihanSearching==3){
        return;
    }
    else{
        cout<<"Pilihan tidak valid"<<endl;
...
int main(){
    ...
    do{
        ...
        switch(pilihanMenu){
            ...
            case 7:
                menuSearching(dataAnimasi, jumlahData);
                break;
